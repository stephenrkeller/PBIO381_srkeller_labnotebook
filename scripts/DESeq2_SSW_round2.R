...
# FOr the homework, you can analyze DE for each subset of the location data:
dds_int <- DESeqDataSetFromMatrix(countData = countData, colData = colDataint, design = ~ health)
dds_sub <- DESeqDataSetFromMatrix(countData = countData, colData = colDatasub, design = ~ health)
...
ddsTS <- DESeqDataSetFromMatrix(countData = countData, colData = colData, design = ~ health + day + health:day)
